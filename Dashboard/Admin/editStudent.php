...
$sql = "SELECT * FROM Student_data WHERE ID ='" . $_GET["student_id"] . "'";
...
if (isset($_POST['updateStudent'])) {
    ...
    $sql = " UPDATE student_data SET ID=$studentID,fname='$fname',lname='$lname',
    email='$email',phone=$phone,age=$age,country='$country',address='$address',
    course='$course',year=$year,username='$username',password='$password',userType='$userType' WHERE ID = '" . $_GET["student_id"] . "'";
...
<div class="wrapper">
    ...
    <div class="main rounded-4">
        <nav class="navbar navbar-expand px-4 ms-1">
            ...
            <div class="display-6">Update Student Details</div>
                    ...
                    while ($row = mysqli_fetch_assoc($result)) {
                        ...
                        <form class="my-4" action="#" method="POST">
                            <div class=" col-12">
                                <div class="card">
                                    <div class="card-body">
                                        <div class="h5 pb-3">Enter new Details</div>
                                        ...
                                        <div>
                                            ...
                                            <div class="mb-3 row">
                                                <div class="mb-3 col">
                                                    ...
                                                    <input type="number" class="form-control" min="22" max="100" step="1"
                                                        value="<?php echo $row['age']; ?>" id="age" name="age" required>
                                                </div>
                                            ...
                                            <div class="mb-3">
                                                ...
                                                <input type="text" class="form-control" id="address" name="address"
                                                    placeholder="Residential Address" value="<?php echo $row['address']; ?>"
                                                    required>
                                            </div>
                                            ...
                                            <div class="mb-3">
                                                ...
                                                <select class="form-control" id="course" name="course" required>
                                                    ...
                                                    while ($row2 = mysqli_fetch_assoc($result2)) {
                                                        ?>
                                                        <option><?php echo "{$row2['courseTitle']}"; ?></option>
                                                        <?php
                                                    }
                                                    ?>
                                                </select>
                                            ...
                                            <div class="mb-3 row">
                                                <div class="mb-3 col">
                                                    ...
                                                    <input type="number" class="form-control" id="studentid"
                                                        name="studentID" value="<?php echo $row['ID']; ?>"
                                                ...
                                                <div class="mb-3 col">
                                                    ...
                                                    <input class="form-control" type="number" min="1900" max="2099" step="1"
                                                        value="<?php echo $row['year']; ?>" id="year" name="year"
                                        ...
                                        <div class="mb-3 row">
                                            <div class="mb-3 col">
                                                ...
                                                <input type="username" class="form-control" id="username" name="username"
                                                    value="<?php echo $row['username']; ?>" minlength="5" required>
                                            ...
                                            <div class="mb-3 col">
                                                ...
                                                <input type="password" class="form-control" id="password" name="password"
                                                    value="<?php echo $row['password']; ?>" minlength="5" required>
                            ...
                            <div class="col-12 text-end">
                                <button type="submit" class="btn btn-primary w-25 px-3" name="updateStudent"
                                    value="updateStudent">Update</button>
                            </div>
